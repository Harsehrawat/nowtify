...
public class CategoryRVAdapter extends RecyclerView.Adapter<CategoryRVAdapter.ViewHolder> {
    ...
    public interface CategoryClickInterface{
        void onCategoryClick(int position);  // we'll use this method in mainAct. so that on clicking diff. category,diff. news sectn opens up .
        // positn will be used to get data from our arrayList .
    }
